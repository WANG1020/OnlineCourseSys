							...
							<div class="tab-pane active divwra1" id="tab1">
								<%--基本信息开始 --%>
									...
									<ul style="list-style:none;">
										<li class="clearfix">
											<div class="personPic">
												<form action="../UpdateUserImageServlet1?location=teacher" method="post" enctype="multipart/form-data" onsubmit="return checkImgSubmit();">
										...
										<li class="clearfix">
											<div  class="liwra1">
											<form action="../updateEmailServlet?location=teacher" method="post" onsubmit="return checkEmailSubmit();">
