...
<div class="row">
		...
		<div style="padding-left:16px;">
			...
			<%if(flag.equals("0")||flag=="0"){ %>
				<video src=<%=dirlist.get(0).getResources() %> autoplay="autoplay" controls="controls" width="760px">
				</video>
			<%} 
